...
public class HistorySVKVangAdapter extends ArrayAdapter<DataSessionDetailStudent> {
    private final Activity activity;
    int resource;

    public HistorySVKVangAdapter(@NonNull Context context, int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView txtMssv = spView.findViewById(R.id.item_dsdd_mssv);
        TextView txtName = spView.findViewById(R.id.item_dsdd_hoten);
        TextView txtClass = spView.findViewById(R.id.item_dsdd_lop);
